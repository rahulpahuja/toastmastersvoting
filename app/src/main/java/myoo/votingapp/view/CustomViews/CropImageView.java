...
import myoo.votingapp.view.Activity.CropImageActivity;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (cropImageActivity.mWaitingToPick) {
                    ...
                    if (true) {
                        // This section of code is optional. It has some getUsersListRef
                        // benefit in that moving the crop rectangle against
                        // the edge of the screen causes scrolling but it means
                        // that the crop rectangle is no longer fixed under
                        // the getUsersListRef's finger.
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                // the getUsersListRef to move the image around.  This call to center puts
